...
<div class="w3-container w3-center w3-round-xlarge">
    <nav class="w3-bar-block  w3-light-grey w3-animate-top w3-card w3-round-xlarge w3-display-bottommiddle">
        <h5 style="color:steelblue" class="text w3-animate-fading">User By Name</h5>
...
<%--                   id="myTable1">--%>
        ...
        <h5 style="color:steelblue" class="text w3-round-xlarge w3-animate-bottom">USER BY NAME</h5>
    </nav>
</div>
