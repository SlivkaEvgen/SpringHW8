...
//
//import org.goit.springhw8.model.RoleRole;
...
//
//    @GetMapping("new")
//    public ModelAndView addNew(RoleRole role, @NotNull ModelMap model) {
//        return new ModelAndView("role/newRole", model.addAttribute("role", role).addAttribute("list",roleService.getList()));
//    }
//
//    @RequestMapping(value = "new", method = RequestMethod.POST)
//    public ModelAndView addNewPost(@NotNull RoleRole role, ModelMap model) {
//        model.addAttribute("list",roleService.getList());
//        if (role.getId() == null) {
...
//
//    @GetMapping("update/**")
//    public ModelAndView update(RoleRole role, @NotNull ModelMap model) {
//        model.addAttribute("list",roleService.getList());
//        return new ModelAndView("role/updateRole", model.addAttribute("role", role));
//    }
//
//    @RequestMapping(value = "update/**", method = RequestMethod.POST)
//    public ModelAndView updatePost(@NotNull RoleRole role, ModelMap model) {
//        model.addAttribute("list",roleService.getList());
//        if (role.getId() == null) {
